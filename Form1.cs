...
namespace Factura
{
    public partial class Form1 : Form
    {
        ...
        private void cmbProducto_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (nom)
            {
                case "Polo": lblNombre.Text = "Tostadas chicas";break;
                case "Gorra": lblNombre.Text = "Tostadas medianas";break;
                default: lblNombre.Text = "Tostadas grandes";break;
            }
        ...
        private void btnVender_Click(object sender, EventArgs e)
        {
            ...
            Ticket1.TextoCentro("Empresa TOSTADAS CHIMBOMBAS "); //imprime una linea de descripcion
            Ticket1.TextoCentro("**********************************");
            ...
            Ticket1.TextoIzquierda("Le Atendio: Everardo martinez");
            Ticket1.TextoIzquierda("Pedidos: 968 684 3226");
            Ticket1.TextoIzquierda("");
